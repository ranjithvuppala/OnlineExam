...
public interface QuestionDAO {
    @SqlUpdate("CREATE TABLE IF NOT EXISTS Question(question_id int auto_increment primary key, question varchar(255), firstoption varchar(255), secondoption varchar(255),thirdoption varchar(255),fourthoption varchar(255))")
    public void createTable();

    @SqlQuery("SELECT * FROM Question")
    public List<Question> getAllQuestions();

    @SqlUpdate("INSERT INTO `Question` VALUES(:question_id,:question,:firstoption,:secondoption,:thirdoption,:fourthoption)")
    @GetGeneratedKeys
    ...
    @SqlUpdate("UPDATE `Question` set question= :question,firstoption= :firstoption,secondoption= :secondoption,thirdoption= :thirdoption,fourthoption= :fourthoption WHERE question_id = :question_id")
